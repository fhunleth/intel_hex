defmodule FlattenTest do
  ...
  defp test_records(base_address \\ 0) do
    [
  ...
  test "flattens records" do
    result = IntelHex.flatten_to_list(test_records())
  ...
  test "flattens records with non-default padding" do
    result = IntelHex.flatten_to_list(test_records(), fill: 25)
  ...
  test "flattens records with base offset" do
    result = IntelHex.flatten_to_list(test_records(0x10))
  ...
  test "flattens records with base offset and start address" do
    result = test_records(0x10) |> IntelHex.flatten_to_list(start: 0x10)
